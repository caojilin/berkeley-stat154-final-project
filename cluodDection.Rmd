...
```{r}
# Non-Trivial Split Method 1: Split each image into 16 squares, extract 80% training, and 20% testing from each square
...
misclassified2 <- testM2[y_hat_knn != testM2$expert_label,]
...
y_hat_knn2 <- knn(train_filtered, test_filtered, train_validationM2$expert_label, k = 1,
                     prob = TRUE)

misclassified2 <- testM2[y_hat_knn2 != testM2$expert_label,]
```
