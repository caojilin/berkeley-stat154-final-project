...
corrplot(image1_nozero[,c(7, 8, 9, 10, 11)])
...
train_validation <- unique(rbind(training, validation))
test <- unique(testing)
```
...
model_input = "expert_label ~ SD + CORR + NDAI"
# Split 1
train.feature = train_validation[,c(4,5,6)]
train.label = data.frame(expert_label = train_validation[,3])

CVgeneric("logistic", train.feature, train.label, K=10, model_input=model_input)
