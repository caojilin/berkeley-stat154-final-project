...
ggplot(data = images_all) + geom_histogram(aes(x = images_all$CORR, fill = expert_label)) + ggtitle('Distribution of NDAI')
...
ggplot(data = images_all) + geom_histogram(aes(x = images_all$SD, fill = expert_label)) + ggtitle('Distribution of NDAI')
...
ggplot(data = images_all) + geom_histogram(aes(x = images_all$DF, fill = expert_label)) + ggtitle('Distribution of NDAI')
